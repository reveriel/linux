...
extern int page_referenced_one_check(struct page *page, struct vm_area_struct *vma,
			 unsigned long address, void *arg);
extern int try_to_unmap_one_pksm(struct page *page, struct vm_area_struct *vma,
		     unsigned long address, void *arg);
